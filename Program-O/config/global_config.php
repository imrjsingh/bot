...
define('_SESSION_PATH_',  _ADMIN_PATH_ . "ses_2a0dffe1eb9a66f6023f3162{$path_separator}");
...
$remember_up_to = 10;
$debugemail = 'manel.andreu.code@gmail.com';
