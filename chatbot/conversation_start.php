...
$options = array(
  ...
  //  'isAdmin'   => FILTER_SANITIZE_NUMBER_INT,
   // 'isCreator' => FILTER_SANITIZE_NUMBER_INT,
...
if (!empty($say)) {
    ...
    $username = (isset($form_vars['username'])) ? $form_vars['username'] : $username;
    $isAdmin = (isset($form_vars['isAdmin'])) ? $form_vars['isAdmin'] : $isAdmin;
    $isCreator = (isset($form_vars['isCreator'])) ? $form_vars['isCreator'] : $isCreator;
